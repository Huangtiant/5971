...
\begin{column}{0.305\paperwidth}
    ...
    Low correlations belie VIF-elevated one‑hot collinearity.
    \end{minipage}
...
\begin{column}{0.305\paperwidth}
    ...
    \noindent\colorbox{lightgray}{%
        ...
        \fontsize{3.8}{4.6}\selectfont\color{black}%
        \textbf{\color{washured}Project:}~Customer Churn Prediction \& Retention Analysis\\[2pt]%
        \textbf{\color{washured}Group:}~[Group Name]\\[2pt]%
        \textbf{\color{washured}Members:}~[Member 1] \quad [Member 2] \quad [Member 3]%
        \end{minipage}%
    }\par%
    }
